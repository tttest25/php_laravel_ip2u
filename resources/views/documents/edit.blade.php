    ...
    <div class="box-border flex py-4">
        ...
        <div class="w-full min-h-screen p-2 mr-1 bg-white">
            <div class="text-center">
                <h1 class="my-3 text-3xl font-semibold text-gray-700 dark:text-gray-200">Edit document {{ $document->id }}</h1>
                <p class="text-gray-400 dark:text-gray-400">Edit the form below to update.</p>
            </div>
            <div class="m-4">
                ...
                <form action="{{ route('document.update',["slug"=>$document->slug]) }}" method="POST" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    {{--
                            {"id":2,
                    ...
                    <label class="block mb-2">
                        ...
                        <input type="text"
                            ...
                            required
                            type="text" name="slug" id="slugid" placeholder="{{ $document->slug ?? old("slug")}}"
                            {{-- value="{{}}" --}}
                            value="{{ $document->slug ?? old("slug")}}">
                    </label>
                    <label class="block mb-2">
                        ...
                        <input type="text"
                            ...
                            value="{{ $document->objstore['caption'] ?? old("objstore.caption")}}"
                            >
                    </label>
                    <label class="block mb-2">
                        ...
                        <input type="text"
                            ...
                            value="{{$document->objstore['comment'] ?? old("objstore.comment")}}"
                            >
                    ...
                    <label class="block mb-6">
                        ...
                        <textarea
                            ...
                            value="{{old("objstore")}}"
                            rows=6
                            >{{  json_encode($document->objstore,JSON_PRETTY_PRINT ) }}</textarea>
                    </label>
                    ...
                    <label class="block mb-6">
                        <button type="submit" class="w-full px-3 py-4 text-white bg-indigo-500 rounded-md focus:bg-indigo-600 focus:outline-none">Update document</button>
                    </label>
